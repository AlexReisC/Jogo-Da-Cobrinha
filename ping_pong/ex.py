...
while cont:
    ...
    if l1_start < c_pos[1] < l1_end - 20 and c_pos[
        0] <= 19:  # (Parte de cima) Verifica se a bola colidiu com as plataforma esquerda
        maior_x = False
        maior_y = True
        vel_c += 0.1

    elif l1_start + 20 < c_pos[1] < l1_end and c_pos[
        0] <= 19:  # (Parte de baixo) Verifica se a bola colidiu com as plataforma esquerda
        maior_x = False
        maior_y = False
        vel_c += 0.1


    if l2_start < c_pos[1] < l2_end - 20 and c_pos[
        0] >= 787 - 6:  # (Parte de cima) Verifica se a bola colidiu com as plataforma direita
        maior_x = True
        maior_y = True
        vel_c += 0.1

    elif l2_start + 20 < c_pos[1] < l2_end and c_pos[
        0] >= 787 - 6:  # (Parte de baixo) Verifica se a bola colidiu com as plataforma direita
        maior_x = True
        maior_y = False
        vel_c += 0.1
